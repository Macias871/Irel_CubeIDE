...
#define CTP_INT_PORT          GPIOA
#define CTP_INT_IRQn          EXTI15_10_IRQn
#define CTP_INT_IRQHandler    EXTI15_10_IRQHandler
...
/*
	...
	//__HAL_RCC_GPIOA_CLK_ENABLE();		//Turn on the GPIOH clock
