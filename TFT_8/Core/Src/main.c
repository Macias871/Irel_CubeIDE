...
uint16_t* framebuffer0 = (uint16_t*)0xD0000000;
uint16_t* framebuffer1 = (uint16_t*)0xD0010000;
#include "../LIB/touch_gtxxxx.h"
#include "../LIB/touch_gtxxxx_defs.h"
#include "../LIB/BUS.h"
...
/* USER CODE BEGIN 4 */
uint8_t datas[10]= {0,0,10,10,1,1,1,1,1,1};
/* USER CODE END 4 */
