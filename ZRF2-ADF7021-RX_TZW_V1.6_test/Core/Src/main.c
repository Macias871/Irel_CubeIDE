...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, RXTX_Pin|M_CTRL_OUT_Pin|MAIN_PK1_Pin|MAIN_PK2_Pin
                          |SS_Pin|P20_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : MAIN_PK1_Pin MAIN_PK2_Pin P20_Pin */
  GPIO_InitStruct.Pin = MAIN_PK1_Pin|MAIN_PK2_Pin|P20_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
