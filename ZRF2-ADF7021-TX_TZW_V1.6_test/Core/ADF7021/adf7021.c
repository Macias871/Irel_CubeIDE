...
adf_reg_t register_value1;
void test_mode_ON(uint8_t pos, uint16_t time)
{

	register_value1.whole_reg = 0x555555FB; //
	adf_write_reg(&register_value1);

	//set_channel(pos, 1);
	tx_conf.r0_reg.whole_reg = ADF_Channels.TX[pos];
	adf_write_reg(&tx_conf.r0_reg);
	...
	sys_conf.r15.address_bits 	= 15;
	sys_conf.r15.rx_test_mode  	= 0;
	sys_conf.r15.tx_test_mode 	= 6;
	sys_conf.r15.sd_test_mode 	= 0;
	sys_conf.r15.cp_test_mode 	= 0;
	sys_conf.r15.clk_mux 		= 0;
	sys_conf.r15.pll_test_mode 	= 0;
	sys_conf.r15.analog_test_mode 	= 0;
	sys_conf.r15.force_ld_high 	= 0;
	sys_conf.r15.reg1_pd 		= 0;
...
void test_mode_OFF(uint8_t pos)
{
	rx_conf.r0_reg.whole_reg = ADF_Channels.RX[pos];
	adf_write_reg(&rx_conf.r0_reg);
